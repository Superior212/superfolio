      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="px-6  z-[100] py-10 bg-neutral-100 sm:max-w-[16rem] lg:w-fit  fixed lg:relative  h-screen left-0 flex flex-col justify-between">
  ...
  return (
    <div className="flex space-x-2">
      ...
      <div className="flex text-sm flex-col">
        <p className="font-bold text-primary">Samson Aderonmu</p>
